...
def midinote2naturalfreq(midi_pitch, a4=A4, natural_interval_ratios=NATURAL_INTERVAL_RATIOS):
    ...
    for i, itv in enumerate(interval):
        ratios[i] = NATURAL_INTERVAL_RATIONS[abs(itv)] ** (1 if itv >= 0 else -1)
...
def synthesize_data(in_fn, out_fn=None,
